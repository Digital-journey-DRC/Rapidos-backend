...
import {
  createProductEventValidator,
  viewProductEventValidator,
  addToCartEventValidator,
  addToWishlistEventValidator,
  purchaseEventValidator,
  searchEventValidator,
} from '#validators/product_event'
...
export default class EventsController {
  /**
   * Endpoint générique pour enregistrer un événement
   * POST /api/events ou /analytics/events
   */
  async store({ request, response, auth }: HttpContext) {
    try {
      ...
      // Logger l'événement via le service
  ...
  /**
   * Endpoint pour enregistrer un événement view_product
   * POST /api/events/view-product
   */
  async logViewProduct({ request, response, auth }: HttpContext) {
    try {
  ...
  /**
   * Endpoint pour enregistrer un événement add_to_cart
   * POST /api/events/add-to-cart
   */
  async logAddToCart({ request, response, auth }: HttpContext) {
    try {
  ...
  /**
   * Endpoint pour enregistrer un événement add_to_wishlist
   * POST /api/events/add-to-wishlist
   */
  async logAddToWishlist({ request, response, auth }: HttpContext) {
    try {
  ...
  /**
   * Endpoint pour enregistrer un événement purchase
   * POST /api/events/purchase
   */
  async logPurchase({ request, response, auth }: HttpContext) {
    try {
  ...
  /**
   * Endpoint pour enregistrer un événement search
   * POST /api/events/search
   */
  async logSearch({ request, response, auth }: HttpContext) {
    try {
