...
export const createClientExpressValidator = vine.compile(
  vine.object({
    ...
    pays: vine.string().trim().maxLength(255).optional(),
    province: vine.string().trim().maxLength(255).optional(),
    ville: vine.string().trim().maxLength(255).optional(),
    commune: vine.string().trim().maxLength(255).optional(),
    avenue: vine.string().trim().maxLength(255).optional(),
